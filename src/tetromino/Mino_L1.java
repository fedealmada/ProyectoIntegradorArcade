...
public class Mino_L1 extends Mino{
    ...
    public void getDirection1(){ // Método para obtener la dirección 1 (vertical)
     // o
     // o
     // o o  
    ...
    public void getDirection3(){ // Método para obtener la dirección 3 (invertida vertical)
        // o o
        //   o
        //   o
        tempB[0].x = b[0].x; // Copia la posición x del primer bloque al bloque temporal
        ...
        tempB[3].x = b[0].x - Block.SIZE; // Copia la posición x del cuarto bloque al bloque temporal (una posición a la izquierda del primero)
